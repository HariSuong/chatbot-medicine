...
export const UserSchema = z.object({
  id: z.string().uuid(), // id là String @default(uuid()), nên là string và validate dạng UUID
  email: z.string().email(), // email là String @unique, nên là string dạng email
  ...
  avatarUrl: z.string().url().nullable(), // avatarUrl là String?, có thể null, thêm .url() nếu là đường dẫn URL
